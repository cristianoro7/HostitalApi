 ...
 */
@WebServlet(urlPatterns = "/admin/doctor/delete", initParams = @WebInitParam(name = "result", value = "/admin/doctor.result"))
public class DeleteDoctorController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        DoctorResult doctorResult = service.deleteDoctor(id);
